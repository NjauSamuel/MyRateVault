...
@section('content')
    ...
    <div class="content p-6">
        ...
        <form action="{{route('auth.store')}}" method="POST" class="shadow-xl p-2 pt-5 border border-slate-200">
            @csrf
            <div class="mb-8">
    ...
    <div class="flex mx-auto items-center justify-center">
        ...
        <div class="min-w-[314px]">
            <p class="font-bold mb-2">Or</p>

            <a class=" text-black font-semibold hover:text-gray-900 flex items-center justify-center space-x-5 border rounded-full border-slate-400 shadow-xl bg-white text px-3 py-1" href="">
